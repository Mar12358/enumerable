...
**Enumerable** is a coding challeng at Microverse's Module 4.
...
```sh
  cd my-folder
  git clone https://github.com/Mar12358/enumerable.git
```
...
Feel free to check the [issues page](https://github.com/Mar12358/enumerable/issues).
